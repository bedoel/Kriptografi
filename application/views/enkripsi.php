    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="#!">Mohammad Azzam Urzaiz (17210484)</a></li>
                <li>
                    <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" href="#!">Muhammad Reza Saputra (17210291)</a></li>
                <li>
                    <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" href="#!">Mohammad Riadus Sholeh (17210799)</a></li>
                <li>
                    <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" href="#!">Zharfan Fadlillah Mursid (17210913)</a></li>
                <li>
                    <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" href="#!">Fadlur Rahman Fa'iq (17210297)</a></li>
            </ul>
        </li>
    </ul>
</nav>
            ...
            <div class="container-fluid px-4">
                ...
                <form action="<?= base_url('Kripto/process'); ?>" method="POST">
                    <div class="row mb-3">
                        ...
                        <div class="mt-3">
                            <div class="form-floating">
                                <textarea class="form-control" name="usertext" placeholder="Leave a text here" id="usertext" style="height: 200px"><?= $output ?? null; ?></textarea>
